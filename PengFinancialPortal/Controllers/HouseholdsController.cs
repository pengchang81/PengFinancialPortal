...
namespace PengFinancialPortal.Controllers
{
    public class HouseholdsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Greeting,Created")] Households households)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Greeting,Created")] Households households)
        {
            if (ModelState.IsValid)
            {
